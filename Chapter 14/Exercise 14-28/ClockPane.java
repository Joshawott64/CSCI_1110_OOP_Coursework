...
public class ClockPane extends Pane {
	...
	// Construct default clock with current time
	public ClockPane() {
		setCurrentTime();
	}
	
	// Construct clock with specified hour, minute, second, and visibility.
	public ClockPane(int hour, int minute, int second, boolean 
			hourHandVisible, boolean minuteHandVisible, boolean 
			secondHandVisible) {
		this.hour = hour;
		this.minute = minute;
		this.second = second;
	...
	private void paintClock() {
		...
		// Draw second hand if secondHandVisible = true
		Line sLine = new Line();
		...
		// Draw minute hand if minuteHandVisible = true
		Line mLine = new Line();
		...
		// Draw hour hand if hourHandVisible = true
		Line hLine = new Line();
